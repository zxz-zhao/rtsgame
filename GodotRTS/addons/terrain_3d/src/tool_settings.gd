...
func create_submenu(p_parent: Control, p_button_name: String, p_layout: Layout, p_hover_pop: bool = true) -> Container:
	...
	if p_button_name.is_empty():
		...
		var display_name = translate_to_zh(p_button_name)
		menu_button.set_text(display_name if display_name != p_button_name else p_button_name)
...
func add_setting(p_args: Dictionary) -> void:
	...
	match p_type:
		SettingType.LABEL:
			var label := Label.new()
			var translated_text = translate_to_zh(p_name)
			label.set_text(translated_text if translated_text != p_name else p_label)
	...
	if not (p_flags & NO_LABEL):
		...
		var display_label = translate_to_zh(p_name)
		if display_label == p_name:
			display_label = p_label if not p_label.is_empty() else p_name.capitalize()
			display_label = display_label.capitalize()
		label.set_text(display_label + ": ")
...
func translate_to_zh(p_name: String) -> String:
	match p_name:
		"instructions": return "在地形上点击添加区域，CTRL+点击删除区域。或者在左侧选择其他工具。"
		"size": return "画笔大小"
		"strength": return "画笔强度"
		"height": return "高度值"
		"color": return "涂抹颜色"
		"roughness": return "湿度/粗糙度"
		"enable_texture": return "启用贴图"
		"texture_filter": return "贴图过滤"
		"margin": return "边缘余量"
		"slope": return "坡度限制范围"
		"enable_angle": return "启用旋转角度"
		"angle": return "旋转角度"
		"dynamic_angle": return "动态随机角度"
		"enable_scale": return "启用缩放"
		"scale": return "缩放波动"
		"gradient_points": return "倾斜控制点"
		"drawable": return "启用绘制"
		"height_offset": return "高度偏移"
		"random_height": return "随机高度波动 ±"
		"fixed_scale": return "固定缩放比例"
		"random_scale": return "随机缩放范围 ±"
		"fixed_spin": return "自转角度 (Y轴)"
		"random_spin": return "随机旋转范围 ±"
		"fixed_tilt": return "倾斜角度"
		"random_tilt": return "随机倾斜范围 ±"
		"align_to_normal": return "对齐地面法线"
		"vertex_color": return "顶点混色"
		"random_hue": return "随机色相偏移 ±"
		"random_darken": return "随机变暗范围"
		"invert": return "反转绘制"
		"auto_regions": return "雕刻时自动增加分区"
		"align_to_view": return "画笔对齐视口"
		"show_cursor_while_painting": return "绘制时显示光标"
		"gamma": return "伽马校正 (Gamma)"
		"jitter": return "绘制抖动"
		"crosshair_threshold": return "十字光标限制"
		"height_picker": return "高度采集"
		"color_picker": return "颜色采集"
		"roughness_picker": return "粗糙度采集"
		"angle_picker": return "角度采集"
		"scale_picker": return "缩放采集"
		"Height": return "高度属性"
		"Scale": return "缩放属性"
		"Rotation": return "旋转属性"
		"Color": return "颜色属性"
		"Brush": return "画笔样式"
		_: return p_name
